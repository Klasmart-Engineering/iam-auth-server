...
docker build -f Dockerfile-With-Credentials -t kidsloop-beta-auth .
...
aws ecs update-service --service arn:aws:ecs:ap-northeast-2:494634321140:service/beta-hub/kidsloop-beta-auth --force-new-deployment --cluster beta-hub --region ap-northeast-2