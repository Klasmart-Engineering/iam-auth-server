...
// we care more about being bug-for-bug compatable with it then correctly normalizing to E.164
// that's why we opt not to use a 3rd party libary
// for example google's libphonenumber accepts letters as vanity numbers
...
const getCountryCallCodeFromString = (
    phoneNumber: string
